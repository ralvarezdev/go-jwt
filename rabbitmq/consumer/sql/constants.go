...
CREATE TABLE IF NOT EXISTS refresh_tokens (jti TEXT PRIMARY KEY);
`

	// InsertRefreshTokenQuery is the SQL query to insert a new refresh token
	InsertRefreshTokenQuery = `
INSERT OR IGNORE INTO refresh_tokens (jti) VALUES (?);
`
